...
latex_documents = [
    (master_doc, 'AkeneoPIMPythonAPIClient.tex', 'Akeneo PIM Python API Client Documentation',
     'matthieudelaro', 'manual'),
]
...
man_pages = [
    (master_doc, 'akeneopimpythonapiclient', 'Akeneo PIM Python API Client Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AkeneoPIMPythonAPIClient', 'Akeneo PIM Python API Client Documentation',
     author, 'AkeneoPIMPythonAPIClient', 'One line description of project.',
     'Miscellaneous'),
]
